    ...
    ***************************************************************************** */
    ...
    var TuiStepperComponent = /** @class */ (function () {
        ...
        TuiStepperComponent.prototype.indexOf = function (step) {
            return i2.tuiGetOriginalArrayFromQueryList(this.steps).findIndex(function (_b) {
        ...
        TuiStepperComponent.prototype.moveFocus = function (current, step) {
            ...
            var stepElements = this.steps.toArray().map(function (_b) {
                var nativeElement = _b.nativeElement;
                return nativeElement;
            });
            var index = stepElements.findIndex(function (element) { return element === current; });
            i2.tuiMoveFocus(index, stepElements, step);
        };
        TuiStepperComponent.prototype.scrollIntoView = function (index) {
            var _a;
            var step = (_a = this.steps.get(index)) === null || _a === void 0 ? void 0 : _a.nativeElement;
            if (!step) {
                return;
            }
