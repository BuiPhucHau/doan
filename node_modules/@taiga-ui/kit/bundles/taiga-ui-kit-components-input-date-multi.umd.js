(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@maskito/kit'), require('@taiga-ui/cdk'), require('@taiga-ui/core'), require('@taiga-ui/kit/classes'), require('@taiga-ui/kit/components/input-tag'), require('@taiga-ui/kit/tokens'), require('@taiga-ui/kit/utils'), require('@tinkoff/ng-polymorpheus'), require('rxjs/operators'), require('@maskito/angular'), require('@angular/common'), require('rxjs')) :
    typeof define === 'function' && define.amd ? define('@taiga-ui/kit/components/input-date-multi', ['exports', '@angular/core', '@angular/forms', '@maskito/kit', '@taiga-ui/cdk', '@taiga-ui/core', '@taiga-ui/kit/classes', '@taiga-ui/kit/components/input-tag', '@taiga-ui/kit/tokens', '@taiga-ui/kit/utils', '@tinkoff/ng-polymorpheus', 'rxjs/operators', '@maskito/angular', '@angular/common', 'rxjs'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory((global["taiga-ui"] = global["taiga-ui"] || {}, global["taiga-ui"].kit = global["taiga-ui"].kit || {}, global["taiga-ui"].kit.components = global["taiga-ui"].kit.components || {}, global["taiga-ui"].kit.components["input-date-multi"] = {}), global.ng.core, global.ng.forms, global.kit, global.i6, global.i1, global["taiga-ui"].kit.classes, global["taiga-ui"].kit.components["input-tag"], global["taiga-ui"].kit.tokens, global["taiga-ui"].kit.utils, global.i5, global.rxjs.operators, global.i3, global.ng.common, global.rxjs));
})(this, (function (exports, i0, i4, kit, i6, i1, classes, i2, tokens, utils, i5, operators, i3, i7, i8) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var TuiInputDateMultiComponent = /** @class */ (function (_super) {
        ...
        function TuiInputDateMultiComponent(control, cdr, injector, isMobile, dialogs, mobileCalendar, dateFormat, dateSeparator, dateTexts$, valueTransformer, options, textfieldSize, doneWord$) {
            ...
            _this.valueMapper = function (value) { return value.map(function (item) { return new classes.TuiStringifiableItem(item, function (item) { return String(item); }); }); };
            return _this;
        }
        ...
        TuiInputDateMultiComponent.prototype.onValueChange = function (value) {
            ...
            this.value = value.map(function (_d) {
                var item = _d.item;
                return item;
            });
        };
